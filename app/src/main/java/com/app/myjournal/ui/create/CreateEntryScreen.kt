package com.app.myjournal.ui.create
...
fun CreateEntryScreen(
    ...
    val formattedDate = remember(currentDate) {
        SimpleDateFormat("MMMM dd, yyyy", Locale.getDefault()).format(Date(currentDate))
    }

    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text("Create Entry", fontWeight = FontWeight.ExtraBold) },
                navigationIcon = {
